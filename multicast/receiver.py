...
while True:
    ...
    pilihan = input(
        "\nBergabung ke grup multicast? (Iya/Tidak): "
    ).strip().lower()
    ...
    if pilihan == "iya":
        ...
        print(
            f"\nBerhasil bergabung ke grup multicast {MCAST_GRP}"
        )
        ...
        print(
            "\nReceiver tidak bergabung ke grup multicast"
        )
